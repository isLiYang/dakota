/*
  $Id: HOPSPACK_CddLibWrapper.c 220 2014-01-02 21:24:59Z tplante $
  $URL: https://software.sandia.gov/svn/hopspack/tags/dakota-6.2/src/src-citizens/citizen-gss/HOPSPACK_CddLibWrapper.c $
*/
...
/*!
  \file HOPSPACK_CddLibWrapper.c
  \brief Implement C functions declared in HOPSPACK_CddLibWrapper.h.
			    ...
			    int append)
{
  ...
  *L = NULL;  *num_lineality = 0;
  ...
  /* TDP added this 05/06/2009 to close a memory leak. */
  dd_FreePolyhedra(poly);
  poly = NULL;
