// $Id: HOPSPACK_Mediator.hpp 204 2012-05-17 23:16:55Z tplante $ 
// $URL: https://software.sandia.gov/svn/hopspack/tags/dakota-6.2/src/src-framework/HOPSPACK_Mediator.hpp $ 
...
class Mediator : public CallbackToMediator
{
  public:
     ...
     *  <ul>
     *  <li> A call to "citizenExhange_()", allowing citizens to view
     *       evaluated points and add new points to the current queue.
     *  <li> Clean up of evaluated points.
     *  <li> (A vote by citizens on the priority of points in the queue,
     *       not yet implemented.)
     *  <li> A call to "conveyor->exchange()", where computing resources are
     ...
     *  <li> A call to "makeStopTest_()" to decide whether to stop.
     *  </ul>
     *
  ...
  private:
    ...
    //! Maximum number of initial evaluations that can fail.
    int                         _nMaxInitialFailedEvals;
