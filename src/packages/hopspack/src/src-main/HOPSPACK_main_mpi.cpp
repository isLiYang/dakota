// $Id: HOPSPACK_main_mpi.cpp 220 2014-01-02 21:24:59Z tplante $ 
// $URL: https://software.sandia.gov/svn/hopspack/tags/dakota-6.2/src/src-main/HOPSPACK_main_mpi.cpp $ 
                            ...
                            HOPSPACK::GenProcComm &  cGPC)
{
    ...
    try
    {
        nResult = cGPC.init (nCopyArgc, saCopyArgv);
    }
                                   ...
                                   HOPSPACK::GenProcComm &  cGPC)
{
    ...
    //---- EVALUATION WORKERS.
    //TBD...extract evaluator type parameter and pass to ExecutorMPI
                                      ...
                                      HOPSPACK::GenProcComm   &  cGPC)
{
    ...
    Evaluator *  pEvaluator
        = EvaluatorFactory::newInstance (cEvalParams);
    if (pEvaluator == NULL)
    {
           ...
           const char * const  saArgv[])
{
    ...
    int  nProcRank = startProcComm_ (nCopyArgc, saCopyArgv, cGPC);
    if (nProcRank == -1)
        return( nMPI_INIT_FAILED );
