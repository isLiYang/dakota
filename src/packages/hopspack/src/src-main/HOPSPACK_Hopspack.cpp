...
// $URL: https://software.sandia.gov/svn/hopspack/tags/dakota-6.2/src/src-main/HOPSPACK_Hopspack.cpp $
...
//----------------------------------------------------------------------
bool  Hopspack::setInputParameters (const ParameterList &  cParams)
{
...
bool  Hopspack::setInputParameters (const string &  sFileName)
{
    ...
    return( setInputParameters (cParams) );
}
